# CLAUDE.md — shared-remembrance-gateway

**ORGAN II** (Art) · `organvm-ii-poiesis/shared-remembrance-gateway`
**Status:** ACTIVE · **Branch:** `main`

## What This Repo Is

Hosting Home — privacy-first metaverse platform centering digital home as hub for life simulation, memorial spaces, and creator economy
...
📁 .github/
📁 docs/
    Metaverse Hub App Concept Exploration.md
    adr
    metaverse-hub-app-concept-exploration.pdf
    source-materials
📁 src/
    index.ts
📁 tests/
...
**Org:** `organvm-ii-poiesis` | **Repo:** `shared-remembrance-gateway`
